package com.reflektion.framework.wrapper;
...
import static com.reflektion.framework.utils.Constant.PROPRETYFILEPATH;
...
public class RestAssuredCore {
    ...
    public RestResponse invokeRestCallNoResoruce(String requestType) {
        switch (requestType) {
            case "GET":
    ...
    public RestResponse invokeRestCallPostBodyString(String payLoad)
    {
       response= request.log().all().body(payLoad).post();
       return new RestResponse(response);
    }

    public RestResponse invokeRestCallPutBodyString(String payLoad, String resourcePath)
    {
        response= request.log().all().body(payLoad).put(resourcePath);
        return new RestResponse(response);
    }
    /**
     *
